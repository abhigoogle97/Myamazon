...
<head runat="server">
    ...
    <script>
        function disable() {
            console.log("hello");
            document.getElementById("ID_logout").disabled = true;
...
<%--                   <tr>
                     ...
                     width: 173px; height: 160px;" />
                                                               ...
                                                               <tr>
                                                                   <td class="auto-style9">Price:
                                                                       ...
                                                                       <asp:Image ID="imgStar" runat="server" ImageUrl="~/images/star2.png" Visible="true" />
                                                                       Stock:&nbsp;
                                           ...
                                           <asp:Panel ID="pnlMyCart" runat="server" BorderColor="Black" BorderStyle="Inset" BorderWidth="1px" Height="500px" ScrollBars="Auto" Visible="true">
                                       ...
                                       <td align="center" class="style3" align="top">
                                           ...
                                           <asp:Panel ID="pnlCheckOut" runat="server" BorderColor="Black" BorderStyle="Inset" BorderWidth="1px" Height="500px" ScrollBars="Auto" Visible="true">
                   ...
                   <asp:RequiredfieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="txtTotalPrice"  ForeColor="Red">
                            ...
                            --%></td>
                                   ...
                                   <tr>
                                       <td align="center" colspan="2" style="border: thin ridge #9900FF">&nbsp;©<a href="http://www.Amazon.in/">MyAmazon.com</a> 
                                           <a href="TrackYourOrder.aspx">TrackYourOrder||<a "javascript:void(0)" id="ID_login" href="CustomerLogin.aspx">Log in</a> </td>
                                   </tr>
                               </table>
                           </td>
                       </tr>
